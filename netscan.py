...
Welcome to NetScan, a Network Scanner which is used to scan the network for active hosts and open ports.
It is a simple tool that can be used to discover devices on a network and check for open ports on those devices. 
